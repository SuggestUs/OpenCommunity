  ...
  return (
    <div className="User-from flex flex-col">
      ...
      <div className="my-auto space-x-5">
        <div className="my-auto justify-center items-center flex">
          <div className="bg-primary text-black w-1/2 rounded-md p-2 font-semibold cursor-pointer hover:bg-purple-600">
            Sign In
          </div>
        </div>
      </div>
