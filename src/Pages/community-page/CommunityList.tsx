        ...
        <div className="flex flex-col w-full h-screen overflow-auto">
            <div className='flex flex-row h-16 create-community mt-8 border text-center '>
                <span className=' w-1/4 my-auto'>
                    <AddIcon className="text-black w-28 hover:text-green-500 focus:text-green-500 " style={{
                        width: '50px',
                        height: '50px'
                    }} /></span>
                <p className='flex items-center mx-2 font-extrabold shadow-sm'>Create Community</p>
            </div>
                            ...
                            <div className=''>
                                <Link to="/" className="flex">
                                    <Stack direction="row" spacing={2}>
                                        <Avatar alt="Remy Sharp" src="https://encrypted-tbn2.gstatic.com/licensed-image?q=tbn:ANd9GcS1fRj89ql67_k5ahbVD8LXBt6q2-GTOQvS6RItxFRO-9lwM940loEDXjazZj10uz5KhDNs6GOhLih9-S8" style={{
                                            height: '60px',
                                            width: '60px'
                                        }} />
                                    </Stack>
