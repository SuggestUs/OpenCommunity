    ...
    <div className="mx-auto max-w-7xl sm:px-6 p-10 lg:px-8">
      <div className="relative isolate overflow-hidden ">
        <div className="mx-auto max-w-md text-center lg:mx-0 lg:flex-auto lg:py-32 lg:text-left">
          <input
            className="text-3xl font-bold tracking-tight text-black sm:text-4xl outline-none border p-2 rounded-md w-full"
            placeholder="Lorem ipsum dolor, sit amet consectetur adipisicing elit"
          />
          <input
            className="mt-6 text-lg leading-8 text-gray-500 border outline-none p-2 rounded-md w-full"
