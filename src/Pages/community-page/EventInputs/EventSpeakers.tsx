...
export default function EventSpeakersCom() {
  ...
  const changeProfileImageForSpeakes = (Ref: React.RefObject<HTMLInputElement>) => {
    Ref.current?.click();
  }
  ...
  return (
    <>
      <div className="flex md:flex-row flex-col h-auto  w-full flex-wrap justify-normal:md justify-center">
        <div className="flex flex-col my-4 mx-4 justify-center border p-5 hover:border-gray-600">
