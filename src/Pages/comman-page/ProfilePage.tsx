...
export default function ProfilePage() {
  ...
  return (
    <section className="h-screen flex md:flex-row flex-col w-full">
      <NavbarForDashBord />
      <div className="rounded-lg mt-10 shadow-lg border bg-white mx-6 text-xl font-inter flex flex-col scroll-m-0 w-full">
        ...
        <div className="p-1 md:p-12 text-left">
          ...
          <p className="text-black mt-5 font-bold pl-5 md:p-0">organizations</p>
